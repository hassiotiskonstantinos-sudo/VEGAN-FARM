...
const projects = [
  {
    ...
    impact: ["320+ ζώα περισυλλέχθηκαν", "280+ επιτυχημένες υιοθεσίες", "100% αποστείρωση πριν υιοθεσία", "Δίκτυο 50+ αναδόχων"],
  ...
  },
  {
    ...
    status: "Ενεργό",
    year: "2021",
    description: "Δωρεάν κτηνιατρικές υπηρεσίες για αδέσποτα ζώα: εμβολιασμοί, αποστειρώσεις, επείγουσες επεμβάσεις. Συνεργασία με εθελοντές κτηνίατρους.",
    impact: ["500+ αποστειρώσεις", "1.200+ εμβολιασμοί", "80+ χειρουργικές επεμβάσεις", "12 εθελοντές κτηνίατροι"],
...
const categories = ["Όλα", "Περισυλλογή", "Κτηνιατρική", "Αγρόκτημα", "Εκπαίδευση", "Τροφοδοσία", "Καταφύγιο"];
