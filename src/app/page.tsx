...
const campaigns = [
  {
    ...
    description: "Αποστειρώσεις, εμβολιασμοί και επείγουσες χειρουργικές επεμβάσεις για αδέσποτα ζώα του Ζωγράφου.",
    goal: 8000,
    raised: 5200,
  ...
  },
  {
    ...
    description: "Ανέγερση ασφαλούς καταφυγίου για γάτες που ζουν στους δρόμους του Ζωγράφου.",
    goal: 12000,
    raised: 4800,
...
const whyUs = [
  ...
  "10+ χρόνια παρουσίας στην κοινότητα",
];
      ...
      <section className="py-20 bg-gradient-to-r from-green-700 to-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-green-100 text-lg mb-8 max-w-2xl mx-auto">
            €10 πληρώνει ένα εμβόλιο. €25 καλύπτει αποστείρωση. €100 χρηματοδοτεί επείγουσα χειρουργική.
            Κάθε ποσό μετράει.
          </p>
