...
const milestones = [
  { year: "2018", event: "Ίδρυση της ΜΚΟ από ομάδα εθελοντών του Ζωγράφου." },
  { year: "2019", event: "Πρώτη οργανωμένη αποστείρωση 50 αδέσποτων γάτων." },
  { year: "2020", event: "Έναρξη καθημερινής τροφοδοσίας σε 15 σημεία της γειτονιάς." },
  { year: "2021", event: "Δημιουργία κτηνιατρικού δικτύου εθελοντών – 100+ αποστειρώσεις." },
  { year: "2022", event: "Εγκαίνια του vegan αγροκτήματος κοινότητας." },
  { year: "2024", event: "200+ επιτυχημένες υιοθεσίες – αναγνώριση από δήμο Ζωγράφου." },
];
      ...
      <section className="bg-gradient-to-br from-green-800 to-emerald-700 text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-green-100 text-lg max-w-2xl mx-auto">
            Από το 2018 δρούμε στον Ζωγράφου Αθήνας για τα αδέσποτα ζώα και τη βιώσιμη κοινότητα. Είμαστε εθελοντές, γείτονες και αγωνιστές.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { icon: Award, label: "Εγγεγραμμένη ΜΚΟ" },
              { icon: BookOpen, label: "Ετήσιος Απολογισμός" },
