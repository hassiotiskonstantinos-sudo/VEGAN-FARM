...
const campaigns = [
  {
    ...
    description: "Στειρώσεις, εμβολιασμοί και επείγουσες χειρουργικές επεμβάσεις για αδέσποτα ζώα του Ζωγράφου. Κάθε ζώο που περισυλλέγουμε χρειάζεται κτηνιατρική φροντίδα πριν βρει σπίτι.",
    goal: 8000,
    raised: 5200,
  ...
  {
    id: 7,
    title: "Υποδομή Φιλοξενίας Σκύλων για Υιοθεσία",
    description: "Κατασκευή κλωβών, στεγάστρων και χώρων άσκησης για σκύλους που αναμένουν υιοθεσία. Έχουμε ήδη συγκεντρώσει €10.000 — χρειαζόμαστε άλλα €5.000 για να ολοκληρώσουμε το έργο!",
    goal: 5000,
    raised: 0,
  ...
  {
    id: 8,
    title: "Διάσωση Παραγωγικών Ζώων — Φωτιές & Πλημμύρες",
    description: "Διάσωση και αποκατάσταση ζώων πρώην παραγωγής (χοίροι, κατσίκες, αρνιά, πουλερικά) από φωτιές, πλημμύρες, κακοποίηση και παράνομα εκτροφεία. Τους δίνουμε ζωή με αξιοπρέπεια.",
    goal: 10000,
    raised: 2400,
  ...
  {
    id: 9,
    title: "Χώρος για Διασωσμένα Κουνελάκια",
    description: "Βελτίωση και επέκταση του χώρου φιλοξενίας για κουνέλια που διασώθηκαν από κακοποίηση και εγκατάλειψη. Χρειαζόμαστε πλατφόρμες, κρυψώνες και ιατρικό εξοπλισμό.",
    goal: 3500,
    raised: 800,
  ...
  {
    id: 10,
    title: "Άσυλο για Χήνες & Χοιρινά από Φωτιές",
    description: "Δημιουργία ασφαλούς χώρου για χήνες σωσμένες από πυρκαγιές και χοιρινά διασωσμένα από παράνομα εκτροφεία. Αυτά τα ζώα χρειάζονται χώρο, φροντίδα και αγάπη.",
    goal: 6000,
    raised: 1200,
...
const categories = ["Όλα", "Κτηνιατρική", "Αγρόκτημα", "Καταφύγιο", "Εκπαίδευση", "Τρόφιμα", "Εξοπλισμός", "Υποδομή", "Διάσωση"];
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="relative text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/goat-handfed.jpeg" alt="" fill className="object-cover" priority />
